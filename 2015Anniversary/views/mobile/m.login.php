...
<div id="wrapper">
	...
	<h2><img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/login_title.jpg"></h2>
	<div class="sns-login">
      <ul>
    ...
    <form name="login-form" id="login-form" action="/event/server_api/serviceapi.php?model=WebApi&function=web_login" method="post">
      ...
      <div class="btns">
  		...
  		<div class="btns-alt">
  			<a class="register" href="register.php">註冊新會員</a>
  		</div>
	  </form><!-- #login-form -->
	<div id="copyright">
		<img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/login_pic.jpg">
