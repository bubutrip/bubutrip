...
<div id="wrapper">
	...
	<div id="kv">
		<div class="inTitle"><a href="activity.php" target="_blank"></a><img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_title.jpg"></div>
		<a href="final.php" class="inGetCodeBtn"><img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_get_code_btn.jpg"></a>
		<div class="inTxt"><img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_txt.jpg"></div>
		<div class="inDown"><a href="#prize"><img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_down_btn.jpg"></a></div>
		<? if( !empty($userdata['definfo']) ){ ?>
		<div class="inScore"><span><?=$userdata['count']?></span><img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/score.jpg"></div>
		<? } ?>
	</div>

	<div id="prize">
		<img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_prize1.jpg">
		<img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_prize2.jpg">
		<img src="<?=imgurl?>/event/2015Anniversary/resources/images/m/index_prize3.jpg">
		<br clear="left">
	</div>
