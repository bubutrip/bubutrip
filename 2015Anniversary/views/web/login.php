...
<body>
    ...
    <div id="contents" class="login">
        <h2><img src="<?=imgurl?>/event/2015Anniversary/resources/images/login_title.gif"></h2>
        <div class="loginSquirrel"><img src="<?=imgurl?>/event/2015Anniversary/resources/images/login_squirrel.gif"></div>  
        <div class="account">    
            <form name="login-form" id="login-form" action="/event/server_api/serviceapi.php?model=WebApi&function=web_login" method="post">
                ...
                <div class="descr">
                    ...
                    <a class="register" href="register.php">註冊會員</a>
                </div>
            </form>
            <form name="forgot-form" id="forgot-form" action="/event/server_api/serviceapi.php?model=WebApi&function=forgot" method="post" style="display:none">
                <div class="field username rowElem">
                    <input type="text" name="email" placeholder="帳號 (Email)" style="width:100%">
                </div>
                <div class="field username rowElem">
                    <input type="text" name="unrobot" placeholder="<?=app_get_unrobot_question()?>" style="width:100%">
                </div>
      ...
      $('#login-form .submit').on('click',function(e){
        ...
        $.post(frm.action,$('#login-form').serialize(),function(res){
          ...
          if( res.success==1 ){
            ...
            window.location.href='/event/2015Anniversary/final.php';
          }
        },'json');
      });
