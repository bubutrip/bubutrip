...
<div id="wrapper">	
	<div class="contentsBox1">
		<div class="meetingTxt">
			<h2><img src="images/m_meeting.png" alt="吉祥物見面會"></h2>
			<h3>時間：9/13(日)下午1:30開始<br/>地點：臺北市立動物園，大門廣場</h3>
			<p>BuBuTrip親子旅遊網的吉祥物誕生了！我們將帶來好玩的互動遊戲，有<span class="whiteTxt">奇哥紗布大包巾、扇子、明信片、霜淇淋、麥當勞薯條</span>多項好禮送給你！</p>
			<p class="prizeTxt">現場憑門票即可抽<br/>
			<span class="whiteTxt">Dyson戴森無線吸塵器<br/>(價值$27,900元)</span><br/>
			<span class="whiteTxt">捷安特滑步車<br/>(價值$3,280元)，</span></p>
			<div class="prize"><img src="images/m_prize.png"></div>
		</div>
		<img src="images/m_bg_piank.png">
	</div>
	<div id="logo"><a href="http://www.bubutrip.com.tw/" target="_blank"><img src="images/logo.png"></a></div>
	<nav>
		<a href="m.who.php" class="floatL"><img src="images/m_who_btn.png" alt="吉祥物是誰?"></a>
