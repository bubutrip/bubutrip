...
$(window).load(function(){
	...
	setTimeout(function(){$('.inBox1,.inBox2,.inActivity,.registerBtn').animate({margin:"0 0 50px 0"}).animate({margin:"0",opacity:1});},800);
...
$(document).ready(function() {
	...
	$('#fullpage').fullpage({
		...
		'afterLoad': function(anchorLink, index){
					if(index == 3){
						...
						$('.next').animate({opacity:0},1000,'easeOutQuad');
						$('.next a').css({"z-index":"1"});
						$('.top').animate({opacity:1},1000,'easeOutQuad');
						$('.top a').css({"z-index":"2"});
						$('#scrollBox').css({opacity:1});
					}else if(index == 1){
						$('.next').animate({opacity:1},1000,'easeOutQuad');
						$('.next a').css({"z-index":"2"});
						$('.top').animate({opacity:0},1000,'easeOutQuad');
						$('.top a').css({"z-index":"1"});
						$('#scrollBox').css({opacity:1});
					}
				}
	...
	function animateDivers() {
		 ...
		 $('.inActivity img').animate({margin:"-20px 0 0 0"},1000,'easeOutQuad').animate({margin:"0"},1000,'easeOutQuad', animateDivers);
